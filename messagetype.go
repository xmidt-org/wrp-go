...
var mtValidatorMap = map[MessageType]Processor{
	...
	SimpleEventMessageType: &vador{
		Type:                    SimpleEventMessageType,
		Source:                  required,
		Destination:             required,
		TransactionUUID:         optional,
		ContentType:             optional,
		RequestDeliveryResponse: optional,
		Headers:                 optional,
		Metadata:                optional,
		Payload:                 optional,
		PartnerIDs:              optional,
	...
	SimpleRequestResponseMessageType: &vador{
	...
	ServiceRegistrationMessageType: &vador{
		Type:        ServiceRegistrationMessageType,
		ServiceName: required,
		URL:         required,
	},
	ServiceAliveMessageType: &vador{
		Type: ServiceAliveMessageType,
	},
	UnknownMessageType: &vador{
