...
const (
	// ----- content types ----
	codecSelferCcUTF82363 = 1
	codecSelferCcRAW2363  = 255
	// ----- value types used ----
	codecSelferValueTypeArray2363  = 10
	codecSelferValueTypeMap2363    = 9
	codecSelferValueTypeString2363 = 6
	codecSelferValueTypeInt2363    = 2
	codecSelferValueTypeUint2363   = 3
	codecSelferValueTypeFloat2363  = 4
	codecSelferBitsize2363         = uint8(32 << (^uint(0) >> 63))
)

var (
	errCodecSelferOnlyMapOrArrayEncodeToStruct2363 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer2363 struct{}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				r.WriteMapElemKey()
				r.EncodeStringEnc(codecSelferCcUTF82363, `msg_type`)
				r.WriteMapElemValue()
				if false {
				...
				if yyq2[1] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							...
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.Source))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, "")
					}
				}
			} else {
				if yyq2[1] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `source`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							...
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.Destination))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[2] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `dest`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							r.EncodeStringBytesRaw(z.BytesView(string(x.TransactionUUID)))
						} else {
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.TransactionUUID))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[3] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF82363, `transaction_uuid`)
					r.WriteMapElemValue()
					if false {
					} else {
						if z.EncBasicHandle().StringToRaw {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							...
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.ContentType))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[4] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF82363, `content_type`)
					r.WriteMapElemValue()
					if false {
					} else {
						if z.EncBasicHandle().StringToRaw {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							r.EncodeStringBytesRaw(z.BytesView(string(x.Accept)))
						} else {
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.Accept))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[5] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `accept`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `status`)
					}
					r.WriteMapElemValue()
					if yyn21 {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `rdr`)
					}
					r.WriteMapElemValue()
					if yyn26 {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `headers`)
					}
					r.WriteMapElemValue()
					if x.Headers == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[9] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `metadata`)
					}
					r.WriteMapElemValue()
					if x.Metadata == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[10] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `spans`)
					}
					r.WriteMapElemValue()
					if x.Spans == nil {
						r.EncodeNil()
		...
		LABEL40:
			if yyr2 || yy2arr2 {
				...
				if yyq2[11] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF82363, `include_spans`)
					r.WriteMapElemValue()
					if yyn40 {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[12] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							...
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.Path))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[12] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `path`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[13] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `payload`)
					}
					r.WriteMapElemValue()
					if x.Payload == nil {
						r.EncodeNil()
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[14] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							r.EncodeStringBytesRaw(z.BytesView(string(x.ServiceName)))
						} else {
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.ServiceName))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[14] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF82363, `service_name`)
					r.WriteMapElemValue()
					if false {
					} else {
						if z.EncBasicHandle().StringToRaw {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[15] {
					if false {
						...
						if z.EncBasicHandle().StringToRaw {
							...
							r.EncodeStringEnc(codecSelferCcUTF82363, string(x.URL))
						}
					}
				} else {
					if z.EncBasicHandle().StringToRaw {
				...
				if yyq2[15] {
					...
					if z.IsJSONHandle() {
						...
						r.EncodeStringEnc(codecSelferCcUTF82363, `url`)
					}
					r.WriteMapElemValue()
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[16] {
					r.WriteMapElemKey()
					r.EncodeStringEnc(codecSelferCcUTF82363, `partner_ids`)
					r.WriteMapElemValue()
					if x.PartnerIDs == nil {
						r.EncodeNil()
					} else {
...
func (x *Message) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap2363 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				r.ReadMapEnd()
			} else {
		...
		} else if yyct2 == codecSelferValueTypeArray2363 {
			...
			panic(errCodecSelferOnlyMapOrArrayEncodeToStruct2363)
		}
	}
}
...
func (x codecSelfer2363) encSliceSlicestring(v [][]string, e *codec1978.Encoder) {
	var h codecSelfer2363
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer2363) decSliceSlicestring(v *[][]string, d *codec1978.Decoder) {
	var h codecSelfer2363
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2363) encSlicestring(v []string, e *codec1978.Encoder) {
	var h codecSelfer2363
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.WriteArrayStart(len(v))
	for _, yyv1 := range v {
		...
		if false {
			...
			if z.EncBasicHandle().StringToRaw {
				...
				r.EncodeStringEnc(codecSelferCcUTF82363, string(yyv1))
			}
		}
	}
	r.WriteArrayEnd()
...
func (x codecSelfer2363) decSlicestring(v *[]string, d *codec1978.Decoder) {
	var h codecSelfer2363
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
