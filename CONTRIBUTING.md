...
Before Comcast merges your code into the project you must sign the [Comcast Contributor License Agreement (CLA)](https://gist.github.com/xmidt-orgOSS/a7b8933dd8e368535378cda25c92d19a).
...
application, document it in the [README](https://github.com/xmidt-org/comcast-bascule/blob/master/README.md) or [wiki](https://github.com/xmidt-org/comcast-bascule/wiki)! This includes new features, additional variants of behavior and breaking changes.
